...
public class ContentItem implements
    org.apache.thrift.TBase<ContentItem, ContentItem._Fields>,
    java.io.Serializable, Cloneable {
  /**
   * 
   */
  private static final long serialVersionUID = -2654439843343430639L;
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    RAW((short) 1, "raw"), ENCODING((short) 2, "encoding"), CLEANSED((short) 3,
        "cleansed"), NER((short) 4, "ner");
  ...
  static {
    Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(
        _Fields.class);
    tmpMap.put(_Fields.RAW, new org.apache.thrift.meta_data.FieldMetaData(
        "raw", org.apache.thrift.TFieldRequirementType.DEFAULT,
        new org.apache.thrift.meta_data.FieldValueMetaData(
            org.apache.thrift.protocol.TType.STRING, true)));
    tmpMap.put(_Fields.ENCODING, new org.apache.thrift.meta_data.FieldMetaData(
        "encoding", org.apache.thrift.TFieldRequirementType.DEFAULT,
        new org.apache.thrift.meta_data.FieldValueMetaData(
            org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.CLEANSED, new org.apache.thrift.meta_data.FieldMetaData(
        "cleansed", org.apache.thrift.TFieldRequirementType.OPTIONAL,
        new org.apache.thrift.meta_data.FieldValueMetaData(
            org.apache.thrift.protocol.TType.STRING, true)));
    tmpMap.put(_Fields.NER, new org.apache.thrift.meta_data.FieldMetaData(
        "ner", org.apache.thrift.TFieldRequirementType.OPTIONAL,
        new org.apache.thrift.meta_data.FieldValueMetaData(
            org.apache.thrift.protocol.TType.STRING, true)));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
        ContentItem.class, metaDataMap);
  }
  ...
  public ContentItem setCleansed(byte[] cleansed) {
    setCleansed(cleansed == null ? (ByteBuffer) null : ByteBuffer
        .wrap(cleansed));
    return this;
  }
  ...
  public int compareTo(ContentItem other) {
    ...
    lastComparison = Boolean.valueOf(isSetRaw()).compareTo(
        typedOther.isSetRaw());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRaw()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.raw,
          typedOther.raw);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetEncoding()).compareTo(
        typedOther.isSetEncoding());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEncoding()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.encoding,
          typedOther.encoding);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetCleansed()).compareTo(
        typedOther.isSetCleansed());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCleansed()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cleansed,
          typedOther.cleansed);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNer()).compareTo(
        typedOther.isSetNer());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNer()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.ner,
          typedOther.ner);
      if (lastComparison != 0) {
        return lastComparison;
      }
  ...
  private static class ContentItemStandardSchemeFactory implements
      SchemeFactory {
  ...
  private static class ContentItemStandardScheme extends
      StandardScheme<ContentItem> {

    public void read(org.apache.thrift.protocol.TProtocol iprot,
        ContentItem struct) throws org.apache.thrift.TException {
