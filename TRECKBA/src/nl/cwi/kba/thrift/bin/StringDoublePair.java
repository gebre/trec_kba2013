...
public class StringDoublePair implements WritableComparable<StringDoublePair> {
   ...
   */
  public StringDoublePair(String left, double right) {
    set(left, right);
  }
   ...
   */
  public StringDoublePair clone() {
    return new StringDoublePair(this.leftElement, this.rightElement);
  }
  ...
  public static class Comparator extends WritableComparator {
    ...
    public int compare(byte[] b1, int s1, int l1, byte[] b2, int s2, int l2) {
      ...
      if (thisLeftValue.equals(thatLeftValue)) {
        ...
        double thisRightValue = readDouble(b1, s1 + 2 + s1offset);
        double thatRightValue = readDouble(b2, s2 + 2 + s2offset);
  ...
  static { // register this comparator
    WritableComparator.define(StringDoublePair.class, new Comparator());
  }
