 ...
 ******************************************************************************/
package nl.cwi.wikilink.thrift.bin;
 ...
 *
 */
public class ThriftRecordReader extends RecordReader<Text, WikiLinkItemWritable> {
  ...
  private WikiLinkItemWritable value = new WikiLinkItemWritable();
  ...
  @Override
  public WikiLinkItemWritable getCurrentValue() throws IOException,
